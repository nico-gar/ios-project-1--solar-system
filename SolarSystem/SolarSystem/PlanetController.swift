...
struct PlanetController {
    ...
    let planets: [Planet] = [
        ...
        Planet(name: "Venus", planetDescription: "Roman goddess of love", imageName: "venus", orderNumber: PlanetOrder.venus.rawValue, dayLengthInDays: 243, yearLengthInDays: 225, radiusInMiles: 7520, moonCount: 0, ringCount: 0, planetType: PlanetType.terrestrial.rawValue, distanceFromSun: 1, favorite: false),
        
        Planet(name: "Earth", planetDescription: "The ground", imageName: "earth", orderNumber: PlanetOrder.earth.rawValue, dayLengthInDays: 1, yearLengthInDays: 365, radiusInMiles: 3959, moonCount: 2, ringCount: 0, planetType: PlanetType.terrestrial.rawValue, distanceFromSun: 1, favorite: false),
        ...
        Planet(name: "Saturn", planetDescription: "Father of Jupiter", imageName: "saturn", orderNumber: PlanetOrder.saturn.rawValue, dayLengthInDays: 0.445, yearLengthInDays: 10759, radiusInMiles: 36183.7, moonCount: 62, ringCount: 8, planetType: PlanetType.gasGiant.rawValue, distanceFromSun: 9.5, favorite: false),
